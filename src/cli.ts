...
import { calculateHash, calculateEntityHash, calculateActionHash, calculateEventHash } from './core/hash.js';
import { confidenceCalculator } from './core/confidence.js';
import { patternObserver } from './core/patterns.js';
import type { EntityObject, ActionObject, Event, EventChange } from './types/index.js';
  ...
  const scenarios = [
    ...
    },
    {
      ...
      params: {
        ...
        sourceType: 'NewsAgency' as const
      }
    },
    {
